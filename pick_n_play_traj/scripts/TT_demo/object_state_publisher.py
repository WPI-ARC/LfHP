...
#        self.object_pub = rospy.Publisher(rospy.get_namespace() + "visualization_marker", Marker)
    ...
    def spawn_object1(self):
        ...
        msg2 = Marker()
        msg2.header.frame_id = "mocap_world"
        ...
        msg3.color.g = 0.7
        msg3.color.b = 0.3
        #msg3.mesh_resource = "package://heres_how/models/dragon_head.dae" 
        msg3.mesh_resource = "package://heres_how/scripts/TT_demo/dragon_head.dae" 
